...
rem set if_lib_file=C:\WFL\intel\lib\intel64\WHIGG.lib
rem python f2py.py -c --fcompiler=intelvem --compiler=msvc -m _spectrum spectrum.f90 -I%if_inc% %if_a% --build-dir build
python f2py.py -c --fcompiler=intelvem --compiler=msvc -m _spectrum spectrum.f90 -I%if_inc% %if_a% --build-dir build
